...
public interface INutritionTimeZoneService
{
    Task<DateOnly> GetTodayAsync(Guid userId, CancellationToken cancellationToken);
}

public class NutritionTimeZoneService : INutritionTimeZoneService
{
    private readonly FitspireDbContext _context;

    public NutritionTimeZoneService(FitspireDbContext context)
    {
        _context = context;
    }
