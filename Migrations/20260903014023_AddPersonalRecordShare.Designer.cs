...
namespace backend.Migrations
{
    ...
    [Migration("20260903014023_AddPersonalRecordShare")]
    partial class AddPersonalRecordShare
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Modules.AiCoaching.Domain.CoachMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateOnly?>("LocalRequestDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("UserId", "LocalRequestDate")
                        .HasDatabaseName("IX_CoachMessage_UserId_LocalRequestDate");

                    b.ToTable("CoachMessage", (string)null);
                });

            modelBuilder.Entity("backend.Modules.AiCoaching.Domain.CoachThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("LastSummarySequenceNumber")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CoachThread", (string)null);
                });

            modelBuilder.Entity("backend.Modules.AiCoaching.Domain.DailyCoachBriefing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DailyCoachBriefing", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Modules.Media.Domain.MediaAsset", b =>
                {
                    ...
                    b.Property<DateTime?>("ModerationRemovedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("backend.Modules.Moderation.Domain.ModerationAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("SuspensionEndsAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ReportId", "OccurredAtUtc")
                        .HasDatabaseName("IX_ModerationAction_ReportId_OccurredAtUtc");

                    b.ToTable("ModerationAction", (string)null);
                });

            modelBuilder.Entity("backend.Modules.Moderation.Domain.ModerationReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MediaContext")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("Status", "TargetType", "CreatedAt")
                        .HasDatabaseName("IX_ModerationReport_Status_TargetType_CreatedAt");

                    b.ToTable("ModerationReport", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Modules.Nutrition.Domain.CommonFood", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UX_CommonFood_Code");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_CommonFood_Name");

                    b.HasIndex("Category", "DisplayOrder")
                        .HasDatabaseName("IX_CommonFood_Category_DisplayOrder");

                    b.ToTable("CommonFood", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Modules.AiCoaching.Domain.CoachMessage", b =>
                {
                    b.HasOne("backend.Modules.AiCoaching.Domain.CoachThread", "Thread")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("backend.Modules.Moderation.Domain.ModerationAction", b =>
                {
                    b.HasOne("backend.Modules.User.Domain.AppUser", "ModeratorUser")
                        .WithMany("ModerationActions")
                        .HasForeignKey("ModeratorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Modules.Moderation.Domain.ModerationReport", "Report")
                        .WithMany("Actions")
                        .HasForeignKey("ReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.Modules.User.Domain.AppUser", "SubjectUser")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Modules.Moderation.Domain.ModerationReport", b =>
                {
                    b.HasOne("backend.Modules.User.Domain.AppUser", "ReporterUser")
                        .WithMany("ReportsSubmitted")
                        .HasForeignKey("ReporterUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Modules.User.Domain.AppUser", "ResolvedByUser")
            ...
            modelBuilder.Entity("backend.Modules.Social.Domain.Post", b =>
                {
                    ...
                    b.OwnsOne("backend.Modules.Social.Domain.GoalAchievedSnapshot", "GoalAchievedSnapshot", b1 =>
                        {
                            ...
                            b1.Property<string>("GoalTypeName")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("character varying(64)")
                                .HasColumnName("SharedGoalTypeName");

                            b1.Property<Guid>("SourceGoalId")
                                .HasColumnType("uuid")
                                .HasColumnName("SourceGoalId");

                            b1.Property<double>("TargetValue")
                                .HasColumnType("double precision")
            ...
            modelBuilder.Entity("backend.Modules.User.Domain.AppUser", b =>
                {
                    ...
                    b.Navigation("CoachThreads");

                    b.Navigation("CommentLikes");

                    b.Navigation("Comments");

                    b.Navigation("DailyCoachBriefings");
